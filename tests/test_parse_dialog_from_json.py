...
def test_load_simple_sequence():
    ...
    assert dialog_graph.current_node().animation_image_ids == ["image 1"]
    ...
    assert dialog_graph.current_node().animation_image_ids == ["image 2"]
...
def test_load_graph_with_animation():
    ...
    assert dialog_graph.current_node().text == "text 1"
    assert dialog_graph.current_node().animation_image_ids == ["frame 1", "frame 2"]
